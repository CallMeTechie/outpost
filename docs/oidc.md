...
2. Add redirect URI: `https://outpost.yourdomain.com/api/auth/oidc/callback`
...
3. Add redirect URI: `https://outpost.yourdomain.com/api/auth/oidc/callback`
  ...
  oidc:
    clients:
      - client_id: outpost
        ...
        redirect_uris:
          - https://outpost.yourdomain.com/api/auth/oidc/callback
