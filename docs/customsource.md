...
Add your own scripts and snippets to Outpost by connecting a Git repository. You can use public repositories from GitHub, GitLab, or any other Git hosting platform.
...
Your repository syncs automatically when Outpost starts. Push updates to your repository and restart Outpost to see the changes.
